...
<html lang="US-en">
 ...
 <title>Library Mngt System -  Login</title>
			...
			<div class="relative min-h-screen flex flex-col sm:justify-center items-center ">
                <div class="relative sm:max-w-sm md:w-full">
                    ...
                    <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                        <label for="" class="block text-sm text-gray-700 text-center font-semibold" id="labelforw">
                            Login
                        </label>
                       <?php echo '<form method="post" action="'.login($conn).'" class="mt-10">'; ?>
                            ...
                            <div class="mt-7">
                                <input type="submit" name="submit"  class="bg-blue-500 w-full py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105" value="Login">
                            </div>
                            ...
                            <div class="mt-7">
                                <div class="flex justify-center items-center text-sm ">
                                    <label class="w-full text-gray-600">Don't have an account?</label>
                                    <a href="register.php" class="w-full text-blue-500 transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                                        Register
                                    </a>
                                </div>
                            </div>
