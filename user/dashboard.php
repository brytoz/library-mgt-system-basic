...
function UserId($get) {
  ...
  if ($data_query = mysqli_query($conn, $query)) {
    ...
    $RegisNum = UserId('reg_num');
    $fullname = UserId('fullname');
    $department = UserId('department');
    $DateJoined = UserId('joined');
     ...
     <div class="md:m-16 m-3">
          ...
          <div class="mt-2 rounded-lg max-w-sm bg-purple-500 md:bg-purple-500">
            <div class="modal-open ml-2 border bg-white shadow-lg z-99 cursor-pointer ">
              <div class="pl-4 pt-4 pb-16">
                <span class="font-bold text-xl">My Profile </span><br> <span class="font-normal text-sm opacity-75"> Hello User</span>
        ...
        <div class="w-full sm:w-full md:w-1/2 lg:w-1/3 mr-8 ">
          <div class="mt-2 rounded-lg max-w-sm bg-purple-500 md:bg-green-500">
            ...
            <div id="promo" class="ml-2 border bg-white shadow-lg z-99 cursor-pointer">
              <div class="pl-4 pt-4 pb-16">
                <span class="font-bold text-xl"> Books </span><br> <span class="font-normal text-sm opacity-75"> View all books</span>
                <div class="float-right pr-5">
        ...
        <div class="w-full sm:w-full md:w-1/2 lg:w-1/3 mr-8 ">
          <div class="mt-2 rounded-lg max-w-sm bg-purple-500 md:bg-purple-500-500">
            <div id="promo" class="ml-2 border bg-white shadow-lg z-99 ">
              <div class="pl-4 pt-4 pb-16">
                <span class="font-bold text-xl"> 0 </span><br> <span class="font-normal text-sm opacity-75">  Borrowed books</span>
                <div class="float-right pr-5">
      ...
      <div  class="flex justify-center flex-wrap  mt-8 ">
        ...
        <div class="w-full sm:w-full md:w-1/2 lg:w-1/2  ">
          <div class="mt-2 rounded-lg max-w-sm bg-purple-500 md:bg-yellow-600 mr-8">
            <div id="promo" class="ml-2 border bg-white shadow-lg z-99">
        ...
        <div class="w-full sm:w-full md:w-1/2 lg:w-1/2  ">
          <div class="mt-2 rounded-lg max-w-sm bg-red-500 md:bg-red-500 mr-8">
  ...
  <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <p>Fullname : <span class="text-green-600 capitalize  font-bold"> <?php echo $fullname; ?></span></p>
        <p>Registration No : <span class="text-green-600 capitalize font-bold"> <?php echo $RegisNum ; ?></span></p>
        <p>Department : <span class="text-green-600 capitalize font-bold"> <?php echo $department; ?></span></p>
        <p>DateJoined : <span class="text-green-600 capitalize font-bold"> <?php echo $DateJoined; ?></span></p>
        ...
        <div class="flex justify-end pt-2">
         <form method="get">
            <button id="pass" disabled="" name="pass" class=" px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400">Reset Password</button>
         </form>
